...
const USE_WEBRTC = false; // Disabled - WebSocket blocked
const USE_REST_POLLING = true; // Use REST API polling for sync (works without WebSocket!)
const POLL_INTERVAL_MS = 3000; // Check for updates every 3 seconds

// Free backend for REST polling sync
const REST_SYNC_URL = 'https://api.jsonbin.io/v3/b';
const REST_API_KEY = '$2a$10$8YourFreeAPIKeyHere'; // Users can get free key from jsonbin.io
 ...
 *   answeredQuestions: Array<{categoryId: string, questionId: string, p1Answer: number, p2Answer: number}>,
 *   cardFlipped: boolean,
 *   rolling: boolean,
 * }} */
const S = {
